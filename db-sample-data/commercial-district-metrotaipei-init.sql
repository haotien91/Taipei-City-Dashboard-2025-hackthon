...
VALUES (
    ...
    '商業處',
    '顯示雙北各行政區商圈密度分布',
    '此圖表呈現台北市與新北市各行政區的商圈密度分布，包括商店數量、商圈規模等指標。透過雙北行政區視覺化比較，協助了解兩市商業發展差異，為跨市商圈活化政策提供數據支撐。',
    '可用於雙北商圈政策制定、跨市投資評估與區域發展規劃。適合政府部門評估雙北商圈發展潛力差異、投資者進行跨市選址比較，以及商業顧問進行雙北市場分析。',
    '{}',
    '{doit,ntpc}',
    CURRENT_TIMESTAMP,
    CURRENT_TIMESTAMP,
...
VALUES (
    ...
    '可用於台北市商圈政策制定、投資評估與區域發展規劃。適合政府部門評估商圈發展潛力、投資者選址參考，以及商業顧問進行市場分析。',
    '{}',
    '{doit}',
    CURRENT_TIMESTAMP,
    CURRENT_TIMESTAMP,
...
BEGIN
    ...
    RAISE NOTICE '組件數量: 2 (雙北商圈人流分析 + 雙北商圈密度分布)';
    RAISE NOTICE '群組權限: metrotaipei';
    RAISE NOTICE '涵蓋範圍: 台北市12區 + 新北市12主要區域';
    RAISE NOTICE '新增功能: 跨市行政區圖 (雙北商圈密度分布)';
